package com.frame.resource.config;
 ...
 */
@Configuration
@MapperScan(basePackages = com.frame.resource.config.MybatisConfig.PACKAGES, sqlSessionTemplateRef = com.frame.resource.config.MybatisConfig.SQL_SESSION_TEMPLATE_NAME)
